...
//	public void updateFiles(int waitTime, String outputFolder) {
//
//		ClassLoader classLoader = ScrapeState.class.getClassLoader();
//		URL resource = classLoader.getResource("application.properties");
//
//		if (resource == null) {
//			System.out.println("Cannot find application.properties");
//		} else {
//			try (PrintWriter appProp = new PrintWriter(new File(resource.getFile()))) {
//				appProp.println("waitTime: " + waitTime);
//				appProp.println("outputFolder: " + outputFolder);
//			} catch (FileNotFoundException e) {
//				System.out.println("Cannot find application.properties to update properties");
//			}
//		}
//	}
}